...
#    This python script implements a basal ganglia neural network with the use of linear algebra.
#    Calculations are done on vectors of potentials and activations and matrices of weights.
